...
use app\admin\model\Guide as Guides;
...
class Guide extends Base{
    ...
    public function lists(){
        ...
        $list = (new Guides())
            ->alias('p')
            ->field(['p.*','c.name cate_name'])
            ->join('crm_scenic c','p.cate_id = c.id')
    ...
    public function edit(){
        if(request()->isPost()){
            ...
            $id = input('id');
            $field = (new Guides())->where('id',$id)->find()->toArray();
