<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/www/wwwroot/ccc.flv.pet/public/../application/index/view/guide/index.html";i:1581951455;s:66:"/www/wwwroot/ccc.flv.pet/application/index/view/public/header.html";i:1581956307;s:66:"/www/wwwroot/ccc.flv.pet/application/index/view/public/footer.html";i:1581862000;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!--                </div>-->
            ...
            <div class="fz0">
                ...
                <div class='list-item inline-block '>
                    <a href="<?php echo url('guide/detail',array('id'=>$l['id'])); ?>"><img src="<?php echo $l['face']; ?>" width="100%" alt="<?php echo $l['name']; ?>" /></a>
                    <div class="list-item-wrap">
                        <div class="list-item-name over"><a href="<?php echo url('guide/detail',array('id'=>$l['id'])); ?>" title="<?php echo $l['name']; ?>"><?php echo $l['name']; ?></a></div>
