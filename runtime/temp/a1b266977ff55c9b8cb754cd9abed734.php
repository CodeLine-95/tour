<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/ccc.flv.pet/public/../application/admin/view/guide/edit.html";i:1582095885;s:65:"/www/wwwroot/ccc.flv.pet/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="layui-form layui-card-body" pad15>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              ...
              <input type="radio" name="cate_id" title="<?php echo $c['name']; ?>" value="<?php echo $c['id']; ?>" <?php if($c['id'] == $field['cate_id']): ?>checked<?php endif; ?> class="layui-input">
              <?php endforeach; ?>
            </div>
          </div>
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" step="0.00" value="<?php echo $field['price']; ?>" name="price" class="layui-input" id="price">
            </div>
          </div>
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              ...
              <?php else: ?>
              <div id="pic_img" style="margin-top: 10px;">
                <img src="<?php echo $field['face']; ?>" alt="">
              </div>
              <?php endif; ?>
            </div>
          </div>
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="radio" name="sex" title="男" value="1" <?php if($field['sex'] == 1): ?>checked<?php endif; ?> class="layui-input">
              <input type="radio" name="sex" title="女" value="2" <?php if($field['sex'] == 2): ?>checked<?php endif; ?> class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label" for="age">年龄</label>
            <div class="layui-input-block">
              <input type="number" value="<?php echo $field['age']; ?>" class="layui-input" name="age" id="age">
            </div>
          </div>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" value="<?php echo $field['start_t']; ?>" class="layui-input" name="start_t" id="start_t">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label" for="end_t">结束时间</label>
            <div class="layui-input-block">
              <input type="text" value="<?php echo $field['end_t']; ?>" class="layui-input" name="end_t" id="end_t">
            </div>
          </div>
          <div class="layui-form-item">
            <div class="layui-input-block">
...
<script>
  layui.use(['form','upload','laydate'], function(){
    ...
    form.on('submit(add)', function(data){
      $.post('<?php echo url("guide/edit"); ?>',data.field,function (res) {
        if (res.icon == 6){
