<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/www/wwwroot/ccc.flv.pet/public/../application/admin/view/power/add.html";i:1566482652;s:65:"/www/wwwroot/ccc.flv.pet/application/admin/view/public/title.html";i:1581519893;s:66:"/www/wwwroot/ccc.flv.pet/application/admin/view/public/footer.html";i:1566482652;}*/ ?>
<!DOCTYPE html>
<html>
          ...
          <div class="layui-card-body" pad15>
            <form class="layui-form" method="post">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" id="remark" name="remark" lay-verify="required" class="layui-input">
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <div id="layui-xtree-checkbox" id="rules" style=""></div>
                </div>
              </div>
              ...
              <div class="layui-form-item">
                <div class="layui-input-block">
                  <button class="layui-btn layui-btn-normal" lay-submit lay-filter="add">添加角色</button>
                </div>
              </div>
            </form>
