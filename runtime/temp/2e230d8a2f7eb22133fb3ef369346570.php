<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/ccc.flv.pet/public/../application/admin/view/scenic/lists.html";i:1582119765;s:65:"/www/wwwroot/ccc.flv.pet/application/admin/view/public/title.html";i:1581519893;}*/ ?>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
    ...
    <div class="layui-tab layui-tab-brief">
      <crmblok>
          <div style="position: relative;">
            ...
            <button class="layui-btn layui-btn-normal" onclick="crm_admin_show('添加','<?php echo url('Scenic/add'); ?>')"><i class="layui-icon">&#xe608;</i>添加</button>
...
<!--                  <option value="2">昵称</option>-->
      ...
      <table class="layui-table">
          ...
          <?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
            <tr align="center" style="height:500px;"><td colspan="6">暂无景点</td></tr>
          <?php else: foreach($list as $l): ?>
              <tr>
                ...
                <td>
                	<button class="layui-btn layui-btn-normal layui-btn-sm" onclick="crm_admin_show('编辑','<?php echo url('Scenic/edit',['id'=>$l['id']]); ?>')">编辑</button>
  ...
  <script>
  	function del(id)
  	{
  		layer.confirm("您确定删除该景点吗？",function(){
  		  $.post("<?php echo url('Scenic/del'); ?>",{id:id},function (res) {
    ...
    function delAll()
    {
      ...
      layer.confirm("确认删除选择的景点吗？",function(){
        $.post("<?php echo url('Scenic/del'); ?>",{id:JSON.stringify(datas)},function (res) {
          layer.msg(res.msg,{icon:res.icon,time:1000},function(){
            window.location.reload();
          });
        },'json');
