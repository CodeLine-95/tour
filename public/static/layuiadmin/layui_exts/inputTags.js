...
layui.define(['jquery','layer'],function(exports){
  "use strict";
  var $ = layui.jquery,layer = layui.layer,options
  ...
  Class.prototype.enter = function(){
    ...
    options.elem.keypress(function(event){
      ...
      if(keynum == '13'){
        ...
        options.done && typeof options.done === 'function' && options.done(value);
        options.elem.val('');
      }
    })
  };
  ...
  Class.prototype.events = function(){
    ...
    $('#tags').on('click','.close',function(){
      ...
      $('#tags').find('input[type=hidden]').val(hidden)
    })
  };
...
}).link('/static/layuiadmin/layui_exts/inputTags.css')
